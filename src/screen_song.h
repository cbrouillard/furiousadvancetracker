...
void FAT_screenSong_init() {
    ...
    ham_bg[SCREEN_LAYER].ti = ham_InitTileSet(ResData(RES_SCREEN_SONG_RAW), RES_SCREEN_INTRO_RAW_SIZE16, 1, 1);
    ham_bg[SCREEN_LAYER].mi = ham_InitMapSet(ResData(RES_SCREEN_SONG_MAP), 1024, 0, 0);
