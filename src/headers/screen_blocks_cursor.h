...
void FAT_screenBlocks_initCursor() {
    ...
    FAT_screenBlocks_setCurrentSelectedLine(0);
    FAT_screenBlocks_setCurrentSelectedColumn(0);
}
 ...
 */
void FAT_screenBlocks_moveCursorDown() {
    if (FAT_screenBlocks_getCurrentSelectedLine() < SCREENBLOCKS_NB_LINES_ON_SCREEN - 1) {
        if (!(FAT_screenBlocks_cursorY >= SCREENBLOCKS_LAST_BLOCK_Y - 1)) {
            FAT_screenBlocks_cursorY += SCREENBLOCKS_BLOCK_SIZE_Y;
            FAT_screenBlocks_incCurrentSelectedLine();
...
void FAT_screenBlocks_moveCursorUp() {
    ...
    if (FAT_screenBlocks_getCurrentSelectedLine() > 0) {
        if (!(FAT_screenBlocks_cursorY <= SCREENBLOCKS_FIRST_BLOCK_Y - 1)) {
            FAT_screenBlocks_cursorY -= SCREENBLOCKS_BLOCK_SIZE_Y;
            FAT_screenBlocks_decCurrentSelectedLine();
            FAT_screenBlocks_printInfos();
        }
    } else {
        FAT_screenBlocks_setCurrentSelectedLine(SCREENBLOCKS_NB_LINES_ON_SCREEN - 1);
...
void FAT_screenBlocks_moveCursorRight(){
    ...
    if (FAT_screenBlocks_getCurrentSelectedColumn() == SCREENBLOCKS_COLUMN_ID_BLK){

        FAT_screenBlocks_cursorX += SCREENBLOCKS_BLOCK_SIZE_X + SCREENBLOCKS_WHITE_SPACE_X;
        FAT_screenBlocks_setCurrentSelectedColumn(SCREENBLOCKS_COLUMN_ID_TSP);

    } else  if (FAT_screenBlocks_getCurrentSelectedColumn() == SCREENBLOCKS_COLUMN_ID_TSP){

        FAT_screenBlocks_cursorX += SCREENBLOCKS_BLOCK_SIZE_X + SCREENBLOCKS_WHITE_SPACE_X;
        FAT_screenBlocks_setCurrentSelectedColumn(SCREENBLOCKS_COLUMN_ID_CMD_NAME);

    } else if (FAT_screenBlocks_getCurrentSelectedColumn() == SCREENBLOCKS_COLUMN_ID_CMD_NAME){

        FAT_screenBlocks_cursorX += SCREENBLOCKS_BLOCK_SIZE_X;
        FAT_screenBlocks_setCurrentSelectedColumn(SCREENBLOCKS_COLUMN_ID_CMD_PARAM);
    }
 ...
 */
void FAT_screenBlocks_moveCursorLeft(){
    if (FAT_screenBlocks_getCurrentSelectedColumn() == SCREENBLOCKS_COLUMN_ID_TSP){

        FAT_screenBlocks_cursorX -= SCREENBLOCKS_BLOCK_SIZE_X + SCREENBLOCKS_WHITE_SPACE_X;
        FAT_screenBlocks_setCurrentSelectedColumn ( SCREENBLOCKS_COLUMN_ID_BLK);
    ...
    } else if (FAT_screenBlocks_getCurrentSelectedColumn() == SCREENBLOCKS_COLUMN_ID_CMD_PARAM){
        FAT_screenBlocks_cursorX -= SCREENBLOCKS_BLOCK_SIZE_X;
        FAT_screenBlocks_setCurrentSelectedColumn( SCREENBLOCKS_COLUMN_ID_CMD_NAME);
    }
}
