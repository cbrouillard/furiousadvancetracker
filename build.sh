...
wine gbfs.exe infos.gbfs samples/0nbkit > /dev/null

# Packaging des samples déjà inclus.
wine gbfs.exe devmess.gbfs samples/dev-mess/0infos samples/dev-mess/*.snd > /dev/null
wine gbfs.exe littlescale-md.gbfs samples/littlescale-md/0infos samples/littlescale-md/*.snd > /dev/null
wine gbfs.exe c64-drums.gbfs samples/c64-drums/0infos samples/c64-drums/*.snd > /dev/null
wine gbfs.exe ym-drums.gbfs samples/ym-drums/0infos samples/ym-drums/*.snd > /dev/null
wine gbfs.exe battery.gbfs samples/battery/0infos samples/battery/*.snd > /dev/null
wine gbfs.exe rhythms.gbfs samples/rhythm/0infos samples/rhythm/*.snd > /dev/null
wine gbfs.exe tr606.gbfs samples/tr-606-7/0infos samples/tr-606-7/*.snd > /dev/null
