...
\begin{document}
  ...
  \section{Presentation}
    ...
    \ColoredAnnotation{For example, you can use this channel to generate a kick with this SWEEP param.}

    \paragraph{Channel 2 : PU2} This is exactly the same as the PU1 but without the SWEEP capability.

    \ColoredAnnotation{You can use this channel to play a bass or melody.}
